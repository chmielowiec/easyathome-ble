...
### Fixed
- Relax `bleak` dependency constraints to allow environments pinned to `bleak` 3.x

## [0.2.3] - 2026-04-01

### Fixed
- Relax `bleak-retry-connector` dependency constraints to allow newer 4.x releases used by Home Assistant environments
...
[0.2.3]: https://github.com/chmielowiec/easyathome-ble/releases/tag/v0.2.3
[0.2.4]: https://github.com/chmielowiec/easyathome-ble/releases/tag/v0.2.4
